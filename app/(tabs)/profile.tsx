...
const styles = StyleSheet.create({
  ...
  linkButton: { paddingVertical: tokens.space.s4 },
  statsRow: { flexDirection: 'row', marginTop: tokens.space.s16, ...gapStyle(tokens.space.s10) },
  statCard: {
    flex: 1,
    padding: tokens.space.s12,
  ...
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', ...gapStyle(tokens.space.s8) },
  chip: {
  ...
  searchRow: { flexDirection: 'row', alignItems: 'center', ...gapStyle(tokens.space.s10) },
  searchInput: {
    flex: 1,
    borderWidth: 1,
    borderRadius: tokens.radius.r12,
  ...
  socialRow: { flexDirection: 'row', alignItems: 'center', ...gapStyle(tokens.space.s12) },
  socialButton: {
    width: 44,
    height: 44,
    borderRadius: 22,
